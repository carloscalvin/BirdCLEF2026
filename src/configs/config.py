...
cfg.exp_name = "tf_efficientnet_b2_ns_full_spec_run13"
cfg.num_workers = 0
...
cfg.spec_aug_time_mask = 0.15
cfg.spec_aug_freq_mask = 0.1
cfg.spec_aug_prob = 0.25

cfg.gaussian_noise_prob = 0.5
cfg.gaussian_noise_limit = (0.25, 1.0)
